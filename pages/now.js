    ...
    <>
      ...
      <div>
        ...
        <div>
          <div className="flex justify-between gap-5">
            <div className="mt-2 mb-10 w-1/2 rounded-md border border-gray-600 p-1 text-sm dark:border-gray-200">
              <span className="ml-2 font-semibold">Location:</span> <span>Kurnool, Andhra Pradesh, India</span>
              <br />
        ...
        <div className="pb-4">
          ...
          <br /> */}
          <p>
            My location preference is Hyderbad but I am open to shift to another place for a better
            opportunity.
          </p>
          <br />
          <p>
